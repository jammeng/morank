				...
				<div class="centered">
					...
					<div class="account">
						<input type="text" class="form-control" id="pwd"
							name="inputUserid" required="" autofocus /> <label for="reuserid">아이디</label>
						<div class="bar"></div>
					</div>
					<div class="account">
						<input type="password" class="form-control" id="repwd"
							name="pwd" required="" /> <label for="pwd">비밀번호</label>
						<div class="bar"></div>
					</div>
					<div class="account">
						<input type="password" class="form-control" id="repwd2"
							name="repwd" required="" /> <label for="repwd">비밀번호 확인</label>
						<div class="bar"></div>
					</div>
				</div>
